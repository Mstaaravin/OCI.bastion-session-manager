...
#   ./bastion_session_manager.sh create session -b ocid1.bastion.oc1..example -n my-session \
...
#   ./bastion_session_manager.sh create session -b ocid1.bastion.oc1..example -n secure-session \
...
#   ./bastion_session_manager.sh help create session
#
